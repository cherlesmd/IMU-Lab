...
// OdisHarkinsvisualiser format
  ...
  display.print("X=");
  display.print(accel_angle_x);
  display.setCursor(60, 10);
  display.print(" Y=");
  display.print(accel_angle_y);
  display.setCursor(5, 20);
  display.print(" Z=");
  display.print(accel_angle_z);
  ...
  */
  ...
  display.print(" Z=");
  display.print(angle_z);


  display.drawCircle(int(circ_x), int(circ_y), int(circ_dia), BLACK);
  display.display();
  
  circ_x += accel_angle_x * 0.1;
  circ_x = max(min(circ_x,128),0);
  
  display.drawCircle(int(circ_x), int(circ_y), int(circ_dia), WHITE);
  display.display();
